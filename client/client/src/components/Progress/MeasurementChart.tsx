  ...
  if (data.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600">No measurement data available</p>
        <p className="text-sm text-gray-500">Start logging your measurements to see progress</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        <h3 className="text-sm font-medium text-gray-700 mb-3">Measurement Trends</h3>
