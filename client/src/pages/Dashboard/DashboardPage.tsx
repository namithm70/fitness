...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-fitness-500 to-fitness-600 rounded-xl p-6 text-white">
        <motion.div
        ...
        >
          ...
          <p className="text-fitness-100">
            Ready to crush your fitness goals today? You're on a {user?.streakDays || 0}-day streak!
          </p>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/workouts" className="text-fitness-600 hover:text-fitness-700 text-sm font-medium">
              View all
            </Link>
          </div>
          <div className="card">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <Link to="/workouts" className="btn-primary w-full flex items-center justify-center">
        ...
        <div>
          ...
          <div className="card">
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="w-10 h-10 bg-fitness-100 rounded-lg flex items-center justify-center">
                      <Calendar className="w-5 h-5 text-fitness-600" />
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-900">{workout.name}</h3>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <Link to="/workouts" className="btn-secondary w-full flex items-center justify-center">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl p-6 text-white">
        ...
        >
          ...
          <Link to="/progress" className="inline-flex items-center bg-white text-purple-600 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors">
            View Progress
